...
(fig.~\ref{fig:ex-gwf-rad-disu-grid}\textit{B}) and extracts water from the bottom 10 $ft$ (layer 21 to 25) at a rate of 4000 $ft^3/day$. The remaining model properties are summarized in table~\ref{tab:ex-gwf-rad-disu-01}.
...
\input{../tables/ex-gwf-rad-disu-01.tex}
